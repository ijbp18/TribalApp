package com.home.tribalapp.presentation.userprofile.adapter
...
import kotlinx.android.synthetic.main.item_user_image_list.view.*
 ...
 */
class UserImageListAdapter constructor(context: Context) :
    PagedListAdapter<Image, UserImageListAdapter.PhotoViewHolder>(COMPARATOR) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PhotoViewHolder {
        return PhotoViewHolder(mLayoutInflater.inflate(R.layout.item_user_image_list, parent, false))
    }
