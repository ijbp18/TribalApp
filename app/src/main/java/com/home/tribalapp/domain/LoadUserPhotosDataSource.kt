 ...
 */
class LoadUserPhotosDataSource(private val networkEndpoints: NetworkEndpoints, private val userName: String) : PageKeyedDataSource<Int, Image>() {
    ...
    override fun loadInitial(params: LoadInitialParams<Int>, callback: LoadInitialCallback<Int, Image>) {
        ...
        networkEndpoints.loadPhotosByUser(userName, UnsplashPhotoPicker.getAccessKey(), 1, params.requestedLoadSize)
            .subscribe(object : Observer<Response<List<Image>>> {
                ...
                override fun onNext(response: Response<List<Image>>?) {
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, Image>) {
        ...
        networkEndpoints.loadPhotosByUser(userName, UnsplashPhotoPicker.getAccessKey(), params.key, params.requestedLoadSize)
            .subscribe(object : Observer<Response<List<Image>>> {
                override fun onComplete() {
                    // do nothing on this terminal event
                }
